...
const userSchema = new mongoose.Schema(
  {
    ...
    principleAmount: { type: Number, default: 0 },
    additionalWallet: { type: Number, default: 0 },

    sponsorId: { type: mongoose.Schema.Types.ObjectId, ref: "UserModel", default: null },
    parentId: { type: mongoose.Schema.Types.ObjectId, ref: "UserModel", default: null },
    left: { type: mongoose.Schema.Types.ObjectId, ref: "UserModel", default: null },
    right: { type: mongoose.Schema.Types.ObjectId, ref: "UserModel", default: null },

    username: { type: String },
    name: { type: String, default: "" },
    parentReferedCode: { type: String, default: null },
    ...
    bonusTrade: { type: Number, default: 0 },
    totalBonusTrade: { type: Number, default: 0 },
    ...
    totalFailedTrades: { type: Number, default: 0 },
    ...
    withdrawalBlockedUntil: { type: Date, default: null },
    isIncomeBlocked: { type: Boolean, default: false },
    aiAgentDaily: { type: Number, default: 0 },
    aiAgentTotal: { type: Number, default: 0 },
    isUpgraded: { type: Boolean, default: false },
    twoFASecret: { type: String, default: "" },
    ipAddress: { type: String, default: "" },
    macAddress: { type: String, default: "" },
    depositPrivateKey: { type: String, default: null },
    depositWalletAddress: { type: String, default: null },
